...
import { LogOut, Settings, User, Shield, Loader2, Link2, CheckCircle, AlertTriangle, Globe, Monitor } from 'lucide-react';
import { Layout } from '@/components/layout/Layout';
import { HeroSection } from '@/components/shared/HeroSection';
import { Button } from '@/components/ui/button';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import BroadcastTab from '@/components/account/BroadcastTab';
          ...
          <Tabs defaultValue="account" className="w-full">
            <TabsList className="w-full mb-6">
              ...
              <TabsTrigger value="broadcast" className="flex-1 gap-2">
                ...
                {language === 'pl' ? 'Transmisje' : 'Broadcasts'}
              </TabsTrigger>
            </TabsList>
